...
public class VentasPorcentajeDriver extends Configured implements Tool {
		...
		job.setMapperClass(VentasPorcentajeTemMapper.class);
		job.setCombinerClass(VentasPorcentajeReducer.class);
		job.setReducerClass(VentasPorcentajeReducer.class);
		...
		long total = job.getCounters().findCounter(VENTAS.TOTALES).getValue();
		...
		job.setMapperClass(VentasPorcentajeMapper.class);
        ...
        public static void main(String[] args) throws Exception {
                int resultado = ToolRunner.run(new VentasPorcentajeDriver(), args);

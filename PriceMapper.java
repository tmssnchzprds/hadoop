	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		if (!distrito.equals("")) {
			if (distrito.equals(neighbourhood_district.toString())) {
				context.write(new Text(neighbourhood_name.toString()), new DoubleWritable(price));
			}
		} else if (!ciudad.equals("")) {
			if (ciudad.equals(city.toString())) {
				context.write(new Text(neighbourhood_district.toString()), new DoubleWritable(price));
			}
		} else if (!pais.equals("")) {
			if (pais.equals(country.toString())) {
				context.write(new Text(city.toString()), new DoubleWritable(price));
			}
		} else {
			context.write(new Text(country.toString()), new DoubleWritable(price));
		}
	}
